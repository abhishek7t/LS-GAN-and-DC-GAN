...
#         temp_gen= -tf.log(disc_act) 
#         temp_gen=tf.where(tf.is_nan(temp_gen), tf.zeros_like(temp_gen), temp_gen)
#         temp_gen=tf.where(tf.is_inf(temp_gen), tf.zeros_like(temp_gen), temp_gen)
        
#         temp_disc= tf.where(tf.cast(labels, tf.bool), -tf.log(disc_act), -tf.log(tf.ones_like(labels)-disc_act ))
#         temp_disc=tf.where(tf.is_nan(temp_disc), tf.zeros_like(temp_disc), temp_disc)
#         temp_disc=tf.where(tf.is_inf(temp_disc), tf.zeros_like(temp_disc), temp_disc)        
#         self.gen_loss = tf.reduce_mean( temp_gen)
#         self.disc_loss = tf.reduce_mean(temp_disc)        
